...
const WeatherCard = ({
  ...
  return (
    <div className='w-[22rem] min-w-[22rem] h-[35rem] glassCard p-4'>
      ...
      <div className="recent-searches flex flex-col items-start">
  <h2>Recent Searches</h2>
  <ul className="horizontal-list flex flex-wrap gap-4 text-black">
    {recentSearches?.map((search, index) => (
      <li key={index} className="list-none">{search}</li>
    ))}
  </ul>
</div>
